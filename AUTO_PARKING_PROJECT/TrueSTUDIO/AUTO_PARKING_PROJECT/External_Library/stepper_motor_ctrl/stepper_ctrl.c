...
void check_count_step(GPIO_PinState dir)
{
	...
	HAL_GPIO_WritePin(DIR_DRIVER_PIN_GPIO_Port, DIR_DRIVER_PIN_Pin, GPIO_PIN_SET);
    HAL_Delay(50);
	HAL_GPIO_WritePin(DIR_DRIVER_PIN_GPIO_Port, DIR_DRIVER_PIN_Pin, GPIO_PIN_RESET);
    HAL_Delay(50);
}
